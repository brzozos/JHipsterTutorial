...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'ee3ff9ec-f859-447d-b4c9-8e4478ade218' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('89a580b5-006f-4d79-98ab-b17d5c5fb40c');
      cy.get(`[data-cy="name"]`).should('have.value', '89a580b5-006f-4d79-98ab-b17d5c5fb40c');
