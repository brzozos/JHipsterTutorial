...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.brzoza.tutorial.jhipster.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.brzoza.tutorial.jhipster.security.DomainUserDetailsService", "createSpringSecurityUser");
